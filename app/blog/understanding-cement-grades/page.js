...
export const metadata = {
  title: 'Understanding Cement Grades | EFTA Investments Blog',
  description: 'Learn how to choose the right grade for your electrical and automation projects with our comprehensive guide to industrial applications.',
}
...
const relatedPosts = [
  {
    ...
    excerpt: 'Discover how smart grid technology is revolutionizing power distribution.',
  ...
  {
    title: 'Energy Management Systems: A Comprehensive Guide',
    excerpt: 'Understanding modern energy management systems and their implementation.',
    category: 'Technical Knowledge',
    date: 'Coming Soon',
    readTime: '8 min read',
    slug: '#'
...
export default function CementGradesPage() {
  return (
    <BlogPost 
      title="Understanding Industrial Grade Specifications for Electrical Systems"
      date="March 28, 2025"
      category="Technical Knowledge"
      readTime="7 min read"
    ...
    >
      <p className="lead text-xl mb-6">
        When embarking on any industrial electrical project, selecting appropriate grade components and systems is crucial for ensuring safety, reliability, and cost-effectiveness. EFTA Investments offers multiple specialized solutions designed for specific applications. This guide will help you understand industrial grades and select the right products for your requirements.
      </p>

      <div className="my-8 rounded-sm overflow-hidden relative aspect-w-16 aspect-h-9 bg-gray-100">
        <div className="absolute inset-0 flex items-center justify-center bg-efta-orange/10">
          <Image
            src="/images/products/industrial-grade.jpg"
            alt="Industrial electrical components and systems"
            fill
