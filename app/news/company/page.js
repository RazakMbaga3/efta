    ...
    <div ref={contentRef} className="min-h-screen bg-gray-50">
      ...
      <main className="pt-10 pb-20">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          {/* EFTA Branding Section */}
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-efta-navy mb-4">Company News & Updates</h2>
              <p className="text-xl text-gray-600 mb-8">Stay informed about EFTA's latest developments, achievements, and corporate initiatives</p>
            </div>
          </div>
