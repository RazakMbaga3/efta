...
export default function ProductNewsPage() {
  ...
  // Mock data for product news
  const productNewsArticles = [
    {
      id: 1,
      title: "EFTA Introduces Revolutionary New Cement Grade",
      excerpt: "Our latest cement grade offers superior strength and durability while maintaining environmental sustainability standards. This innovation marks a significant milestone in Tanzania's construction industry.",
      date: "2024-03-15",
      image: "/images/products/new-grade.jpg",
      category: "products",
      featured: true
    },
    {
      id: 2,
      title: "EFTA Cement Achieves ISO Certification Update",
      excerpt: "Our commitment to quality continues as our cement products receive the latest ISO certification, confirming our adherence to international quality standards.",
      date: "2024-02-20",
      image: "/images/certifications/iso-cert.jpg",
      category: "products",
      featured: false
    },
    {
      id: 4,
      title: "Introducing EFTA's Enhanced Quality Control Process",
      excerpt: "We've implemented advanced quality control measures in our production process, ensuring even higher standards of consistency and reliability in our cement products.",
      date: "2024-01-10",
      image: "/images/quality/quality-control.jpg",
      category: "products",
      featured: false
    }
  ];
    ...
    <div ref={contentRef} className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-white/90 text-sm md:text-base max-w-xl">
                Stay updated with our latest product innovations and improvements designed to meet your evolving construction needs.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <main className="pt-10 pb-20">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            <h2 className="text-efta-green text-2xl md:text-3xl font-bold mb-4 font-futura">QUALITY & INNOVATION</h2>
            <p className="text-gray-700">
              At EFTA, we continuously improve our products to deliver superior strength, durability, and performance. Stay informed about our latest product innovations, enhancements, and certifications.
            </p>
          </motion.div>
