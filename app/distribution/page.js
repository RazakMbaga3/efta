...
const distributionNetwork = [
  {
    ...
    contactOffice: "EFTA Headquarters, Kigamboni"
  },
  {
    region: "Arusha",
    services: [
    ...
    coverage: "Arusha and surrounding regions",
    contactOffice: "EFTA Northern Zone Office"
  },
  {
    region: "Mwanza",
    services: [
    ...
    coverage: "Lake Zone regions",
    contactOffice: "EFTA Lake Zone Branch"
  }
];
...
const serviceZones = [
  {
    ...
    regions: ["Dar es Salaam", "Coast Region", "Morogoro"],
    specialization: "Industrial and Commercial Electrical Systems"
  },
  {
    name: "Northern Zone",
    headquarter: "Arusha",
  ...
  },
  {
    name: "Lake Zone",
    headquarter: "Mwanza",
    regions: ["Mwanza", "Mara", "Shinyanga"],
    specialization: "Power Distribution Systems"
  }
];
  ...
  return (
    <>
      ...
      >
        ...
        {/* Truck image positioned on the right side of the banner */}
        <div className="absolute right-0 bottom-0 w-64 h-40 md:w-80 md:h-48">
          <Image 
