          ...
          <div className="grid md:grid-cols-4 gap-8">
            {categories.map((category, index) => (
              <motion.div
                ...
                className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg text-center cursor-pointer hover:bg-efta/5 transition-colors"
              >
                <div className="text-efta mb-4">{category.icon}</div>
...
const projects = [
  ...
  },
  {
    ...
    imageUrl: "/images/projects/smart-grid.jpg",
    completion: "2023"
  },
  {
...
const showcaseProjects = [
  {
    ...
    image: "/images/projects/industrial-power.jpg"
  },
  {
