...
export default function CareersPage() {
  ...
  const jobOpenings = [
    {
      ...
      responsibilities: [
        ...
        "Oversee renewable energy installations",
    ...
    },
    {
      ...
      type: "Full-time",
      requirements: [
        "Technical diploma in electrical/solar systems",
    ...
    },
    {
      ...
      department: "Smart Buildings",
      location: "Dar es Salaam",
      type: "Full-time",
      requirements: [
        "BSc in Electronics/Electrical Engineering",
        "Experience with BMS systems",
        "Knowledge of KNX/BACnet protocols",
        "Programming skills"
      ],
      responsibilities: [
        "Design automation systems",
        "Configure control systems",
        "Implement energy management solutions",
  ...
  const careerBenefits = [
    {
      ...
      description: "Continuous learning opportunities through technical certifications and training programs.",
      icon: "📚"
    },
    {
      title: "Innovation Focus",
      description: "Work with cutting-edge renewable energy and smart building technologies.",
      icon: "💡"
    },
    {
      title: "Career Growth",
  ...
  const trainingPrograms = [
    {
      ...
      duration: "12 months",
      description: "Structured training program for fresh engineering graduates covering electrical systems, renewable energy, and project management.",
      areas: [
    ...
    {
      title: "Technical Specialist Program",
      duration: "6 months",
      description: "Hands-on training program for technical diploma holders focusing on installation and maintenance of electrical and solar systems.",
      areas: [
  ...
  const benefits = [
    ...
    },
    {
      icon: "🌍",
      title: "Impact",
      description: "Work on projects that advance sustainable energy in Tanzania"
    }
  ];
  ...
  const values = [
    {
      title: "Innovation",
      description: "We embrace new technologies and creative solutions in electrical engineering"
    },
    {
      title: "Safety",
      description: "Safety is our top priority in every project and workplace"
    },
    {
      title: "Sustainability",
      description: "We're committed to environmental stewardship through renewable energy"
    },
    {
      title: "Excellence",
      description: "We maintain the highest standards in all our engineering work"
    }
  ];
              ...
              <div className="container mx-auto px-4 max-w-6xl">
                ...
                >
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">
                    At EFTA Investments, we aim to become a key driver in Tanzania's growth by consistently delivering high quality
