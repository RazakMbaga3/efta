...
export default function CareersPage() {
  ...
  return (
    <div className="min-h-screen my-20 bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-center mb-16">
              ...
              <div className="w-20 h-1 bg-efta-500 mx-auto"></div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {benefits.map((benefit, index) => (
                ...
                >
                  <div className="w-12 h-12 bg-efta-50 rounded-lg flex items-center justify-center mb-4">
                    <benefit.icon className="w-6 h-6 text-efta-500" />
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-center mb-16">
              ...
              <div className="w-20 h-1 bg-efta-500 mx-auto mb-6"></div>
                    ...
                    <div className="flex flex-wrap justify-between items-start mb-4">
                      <div>
                        ...
                        <div className="flex items-center mt-2">
                          <span className="text-sm text-gray-600 mr-4">{job.location}</span>
                          <span className="text-sm bg-green-100 text-green-800 px-2 py-1 rounded-full">{job.type}</span>
                        </div>
                      </div>
                      <a
                        href="/contact"
                        className="inline-flex items-center justify-center px-4 py-2 bg-efta-500 text-white rounded-md hover:bg-efta-600 transition-colors"
                      >
                        Apply Now
                      </a>
                    </div>
      ...
      {/* CTA Section */}
      <section className="py-16 bg-efta-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <a
            href="/contact"
            className="inline-flex items-center justify-center px-6 py-3 border border-white text-base font-medium rounded-md text-white bg-transparent hover:bg-white/10 transition duration-300"
          >
            Submit Your Resume
          </a>
        </div>
