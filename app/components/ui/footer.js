        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 mt-4 text-sm leading-relaxed">
              EFTA Investments Ltd is committed to sustainable development and 
              excellence in cement manufacturing, serving Tanzania and East Africa.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/quality-control" className="text-gray-300 hover:text-white transition-colors duration-300">
                  Quality Control
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/distribution" className="text-gray-300 hover:text-white transition-colors duration-300">
                  Distribution
                </Link>
              </li>
            </ul>
