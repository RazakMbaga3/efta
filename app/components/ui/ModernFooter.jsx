        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <form className="flex w-full md:w-auto">
              ...
              <button 
                type="submit" 
                className="bg-gray-900 hover:bg-black px-5 py-3 rounded-r-md font-medium transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <a href="https://facebook.com" className="text-gray-400 hover:text-efta-400 transition-colors">
                <FaFacebook className="h-5 w-5" />
              </a>
              <a href="https://twitter.com" className="text-gray-400 hover:text-efta-400 transition-colors">
                <FaTwitter className="h-5 w-5" />
              </a>
              <a href="https://instagram.com" className="text-gray-400 hover:text-efta-400 transition-colors">
                <FaInstagram className="h-5 w-5" />
              </a>
              <a href="https://linkedin.com" className="text-gray-400 hover:text-efta-400 transition-colors">
                <FaLinkedin className="h-5 w-5" />
              </a>
              <a href="https://youtube.com" className="text-gray-400 hover:text-efta-400 transition-colors">
            ...
            <div className="flex flex-col space-y-2">
              <div className="flex items-center">
                ...
                <a href="tel:+255123456789" className="text-gray-400 hover:text-white transition-colors">
                  +255 123 456 789
                </a>
              </div>
              <div className="flex items-center">
                <HiMail className="h-5 w-5 text-efta-400 mr-3" />
                <a href="mailto:info@efta.co.tz" className="text-gray-400 hover:text-white transition-colors">
                  info@efta.co.tz
                </a>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/services#electrical-contracting" className="text-gray-400 hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 bg-efta-500 rounded-full mr-2"></span>
                  Electrical Contracting
                </Link>
              </li>
              <li>
                <Link href="/services#renewable-energy" className="text-gray-400 hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 bg-efta-500 rounded-full mr-2"></span>
                  Renewable Energy Solutions
                </Link>
              </li>
              <li>
                <Link href="/services/equipment-supply" className="text-gray-400 hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 bg-efta-500 rounded-full mr-2"></span>
                  Equipment Supply
                </Link>
              </li>
              <li>
                <Link href="/services#energy-audits" className="text-gray-400 hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 bg-efta-500 rounded-full mr-2"></span>
                  Energy Audits & Consulting
                </Link>
              </li>
              <li>
                <Link href="/services#maintenance" className="text-gray-400 hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 bg-efta-500 rounded-full mr-2"></span>
                  Maintenance & Support
                </Link>
              </li>
